class PostBody:
#this class stores ll the data sent during a request thats all
    __slots__ = 'data'
    ...
    def get(self, key):
        ...
        if type(value) == str:
            value = cgi.escape(value)  # We are escaping the values to prevent any kind of xss or script injections :))
        return value
